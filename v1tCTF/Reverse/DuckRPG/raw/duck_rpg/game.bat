...
:battle1
call :fight "Angry Duck" 1 8
if "!hero_dead!"=="1" goto gameover
set "frag1=unlock"
goto battle2

:battle2
call :fight "Duck Mage" 1 12
if "!hero_dead!"=="1" goto gameover
set "frag2=the"
goto battle3

:battle3
call :fight "Mother Goose" 1 69
if "!hero_dead!"=="1" goto gameover
set "frag3=goose"
goto victory
...
:result
call result.bat %full% 8392dcc7b6fdebd5a70211c1e21497a553b31f2c70408b772c4a313615df7b60
pause
exit /b
